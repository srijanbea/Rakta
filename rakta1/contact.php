...
<head>
  ...
  <title>Rakta - connect the donors</title>
...
<body id="top">
  ...
  <header class="header">
      ...
      <div class="container">
        <ul class="contact-list">
          <li class="contact-item">
            ...
            <a href="mailto:Rakta001@gmail.com" class="contact-link">Rakta001@gmail.com</a>
          </li>
          <li class="contact-item">
            <ion-icon name="call-outline"></ion-icon>
            <a href="tel:+977-9856003922" class="contact-link">+977-9856003922</a>
          </li>
        </ul>
    ...
    <div class="header-bottom" data-header>
      <div class="container">
        <a href="index.html" class="logo">Rakta</a>
    ...
    <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')"
        ...
        <div class="container">
          <div class="hero-content">
            <img src="assets/images/blood-icon.png" alt="ICON" width="200" height="200"> 
            <p class="section-subtitle">Rakta</p>
            ...
            <p class="hero-text">
            MOBILE: +977-9856003922 | TELEPHONE: 0484-292674<br>
            EMAIL : Rakta001@gmail.com<br>
            </p>
          ...
          <figure class="hero-banner">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d56516.277768685635!2d85.28493324095916!3d27.709030241454187!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb198a307baabf%3A0xb5137c1bf18db1ea!2sKathmandu%2044600!5e0!3m2!1sen!2snp!4v1709913605031!5m2!1sen!2snp" width="700" height="600" style="border:1;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </figure>
        </div>
    </section>
 ...
 <footer class="footer">
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            <a href="tel:+977-9856003922" class="footer-link">+977-9856003922</a>
          </li>
          <li class="footer-item">
            <div class="item-icon">
              <ion-icon name="mail-outline"></ion-icon>
            </div>
            <a href="mailto:help@example.com" class="footer-link">Rakta001@gmail.com</a>
          </li>
        </ul>
      </div>
    </div>
    <div class="footer-bottom">
      <div class="container">
        <p class="copyright">
          &copy; 2024 All Rights Reserved by Rakta
        </p>
        <ul class="social-list">
          <li>
            <a href="#" class="social-link">
